...
% Generate a representative stochastic sampling and attack sequence.
% The sequence still follows the prescribed Bernoulli probabilities, but it
% is regenerated until the no-attack, G1-attack, and G2-attack modes are
% all clearly visible in the plotted interval.
...
%%  
 ...
 % Record the attack-related signals for the added figures.
 ys1_trace(it)     = ys1;
 ys2_trace(it)     = ys2;
